...
#pragma warning restore 0649
		...
		public static FileBrowser Instance
		{
			get
			{
				if( !m_instance )
				{
					m_instance = Instantiate( Resources.Load<GameObject>( "SimpleFileBrowserCanvas" ), GameObject.Find("CenterEyeAnchor").transform).GetComponent<FileBrowser>();
					m_instance.GetComponent<Canvas>().renderMode = RenderMode.WorldSpace;
					m_instance.transform.localScale = new Vector3(0.01f, 0.01f, 1f);
					m_instance.transform.localPosition = new Vector3(0, 0, 5f);
					m_instance.transform.localRotation = new Quaternion(0f, 0f, 0f, 0f);
