...
// Custom visual feedback system for interactable objects in Oculus Interaction.
// Its main functionality is to smoothly change an object's color based on its
// interaction state (normal, hover, selected, disabled).

namespace Oculus.Interaction
{
    public class MyInteractableColorVisual : MonoBehaviour
    {
        ...
        public ColorState ColorForState(InteractableState state)
        {
            switch (state)
            {
